    ...
    <body>
        ...
        <div className="wrapper">
          ...
          <div className="menu">
            <ul>
              ...
              {/* <li><a onclick="closeMenu()" href="#services">Serviço</a></li>
            ...
            {/* <a className="button" onclick="closeMenu()" href="#contact">Agende sua Consulta</a> */}
            <a className="button" href="#contact">Agende sua Consulta</a>

            <ul className="social-links">
              <li>
                <a target="_blank" href="https://instagram.com/jonathas.bonfim/">
              ...
              <li>
                <a target="_blank" href="https://www.facebook.com/jonathas.TheGost">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
              ...
              <li>
                <a target="_blank" href="https://youtube.com/watch?v">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
          ...
          <button aria-expanded="false" aria-label="Abrir menu" className="open-menu">
          ...
          <button aria-expanded="true" aria-label="Fechar menu" className="close-menu">
            <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <section id="home">
        <div className="wrapper">
          ...
          <div className="col-b">
            <img src="./assets/mulher-negra-com-moletom-verde.png" alt="Mulher negra sorrindo" />
          </div>
            ...
            <div className="cards">
              <div className="card">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M17.091 8.18182L10.091 15.1818L6.90918 12" stroke="#00856F" stroke-width="1.5"
                    stroke-linecap="round" stroke-linejoin="round" />
                </svg>
      ...
      <section id="about">
        <div className="wrapper">
          ...
          <div className="col-b">
            <img src="./assets/doutor-realizando-atendimento.png" alt="doutor_felis_segurando_pranjeta" />
          </div>
        </div>
      </section>
        ...
        <div className="wrapper">
          <div className="col-a">
            ...
            <div className="content">
              ...
              <a className="button" target="_blank" href="https://wa.me/5527999724672">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
          ...
          <div className="col-b">
            <img src="./assets/homem-negro-com-moletom.png" alt="homem-negro-com-moletom-mexendo-no-celular" />
          </div>
        </div>
      </section>
      ...
      <footer>
        <div className="wrapper">
          ...
          <div className="col-b">
            <ul className="social-links">
              <li>
                <a target="_blank" href="https://instagram.com/winicios-mauri">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                      d="M17 1.99997H7C4.23858 1.99997 2 4.23855 2 6.99997V17C2 19.7614 4.23858 22 7 22H17C19.7614 22 22 19.7614 22 17V6.99997C22 4.23855 19.7614 1.99997 17 1.99997Z"
                      stroke="#FFFAF1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
              ...
              <li>
                <a target="_blank" href="  https://facebook.com/winicios-mauri">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                      d="M18 1.99997H15C13.6739 1.99997 12.4021 2.52675 11.4645 3.46444C10.5268 4.40212 10 5.67389 10 6.99997V9.99997H7V14H10V22H14V14H17L18 9.99997H14V6.99997C14 6.73475 14.1054 6.4804 14.2929 6.29286C14.4804 6.10533 14.7348 5.99997 15 5.99997H18V1.99997Z"
                      stroke="#FFFAF1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
